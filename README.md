...
| -------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------- |
| Windows  | MSVC (latest)           | [![windows](https://img.shields.io/github/actions/workflow/status/dithrkit/dithr/ci.yml?branch=main&label=build)](https://github.com/dithrkit/dithr/actions/workflows/ci.yml)        | Native (multi-config)               |
| Linux    | GCC (Debug)             | [![linux-gcc-dbg](https://img.shields.io/github/actions/workflow/status/dithrkit/dithr/ci.yml?branch=main&label=build)](https://github.com/dithrkit/dithr/actions/workflows/ci.yml)  | Ninja, shared libs off              |
...
| —        | clang-format-22         | [![fmt](https://img.shields.io/github/actions/workflow/status/dithrkit/dithr/ci.yml?branch=main&label=format)](https://github.com/dithrkit/dithr/actions/workflows/ci.yml)           | C/H formatting check                |
...
| ------------------------------------------ | -------------------------------------------------------- |
| [Getting Started](docs/getting-started.md) | Create, run, and export your first game                  |
